...
if ((!is_admin($mysqli, $_SESSION['artist_id'])) || (empty($_GET['artist_id']))) {
...
?>
    ...
    <div class="row">
        ...
        <div class="span2 text-right "><h4 ><a href="manager.php"> Manage All Users</a></h4></div>
        <br/><br/>
        ...
        if (isset($_GET['status'])) {
            if ($_GET['status']=='1') {
                ...
                <a class="close" data-dismiss="alert" href="#">×</a>There was a problem updating the profile, please try again.
            </div>';
        ...
        <form enctype="multipart/form-data" action="user_update.php" method="post">
            ...
            <input name="artist_id" type = "hidden" value="<?php echo $_GET['artist_id']  ?>"/>
        </form>
        <hr/>
